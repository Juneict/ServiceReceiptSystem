              ...
              <div class="card-body p-0">
                ...
                <table id="customers" class="table">
                  ...
                  @foreach(  $latestorders  as  $latestorder )
                    <tr>
                        <td>{{$latestorder->created_at->format('Y-m-d')}}</td>
                        <td>{{ $latestorder->name}}</td>
                        <td>{{ $latestorder->ph}}</td>
                        <td>{{$latestorder->brand }}</td>
                        <td>{{ $latestorder->part}}</td>
                        <td>{{$latestorder->prepaid}}</td>
                    ...
                    <table id="customers" class="table">
                      ...
                      @foreach( $recentCustomers as $recentCustomer)
                        <tr>
                            ...
                            <td>{{$recentCustomer->name}}</td>
                            <td>{{ $recentCustomer->ph}}</td>
                            <td>{{ $recentCustomer->brand}}</td>                 
                      ...
                      <table id="customers" class="table">
                        ...
                        @foreach( $recentTasks  as $recentTask )
                          <tr>
                              ...
                              <td>{{$recentTask->customers->name}}</td>
                              <td>{{$recentTask->customers->brand}}</td>
                              <td>{{ $recentTask->customers->error}}</td>                 
